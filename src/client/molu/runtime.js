/* generated by scripts/import-molu.py — do not edit by hand */
...
function openBook(id) {
  ...
  b.updated = nowString();
  DATA = b;
  root.classList.remove('view-home');
  initWorkbench();
  markDirty();
}
...
let appInited = false;   /* 幂等保护：DOMContentLoaded 重复触发时避免重复绑定 */
  ...
  $('#sidebarBtn').onclick = () => {
    ...
    root.classList.toggle('collapsed', !state.sidebar);
  };
  ...
  $('#inspectorBtn').onclick = () => {
    ...
    root.classList.toggle('no-inspector', !state.inspector);
  ...
  root.addEventListener('keydown', e => {
    ...
    if (e.key === 'Escape') {
      ...
      else if ((shadow.activeElement || document.activeElement) === $('#searchInput')) { $('#searchInput').value = ''; $('#searchInput').dispatchEvent(new Event('input')); }
    }
  });
